  ...
  const campaigns: Campaign[] = [
    {
      ...
      description:
        "Providing immediate emergency aid including food, water, shelter, and medical supplies.",
    ...
    },
    {
      ...
      description:
        "Long-term recovery support including housing reconstruction and livelihood restoration.",
    ...
    },
    {
      ...
      description:
        "Emergency response for families displaced by recent flash floods.",
      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="text-center mb-16">
          <h2 className="font-['Manrope:Bold',_sans-serif] font-bold text-[60px] leading-[60px] text-[#101828] mb-6">
            <span className="text-blue-900 text-[60px]]">ACTIVE </span>
            <span className="text-[#FACC15]">CAMPAIGNS</span>
          </h2>
          <p className="font-['Nunito:Regular',_sans-serif] font-normal text-[24px] leading-[39px] text-[#4a5565]">
            Support ongoing relief efforts with complete blockchain
            transparency.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {campaigns.map((campaign) => (
            <div
              key={campaign.id}
              className="bg-white rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] overflow-hidden transition-all duration-300 hover:shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.15),0px_8px_10px_-6px_rgba(0,0,0,0.1)] hover:-translate-y-2 cursor-pointer"
            >
              ...
              <div className="p-6">
                ...
                <button className="w-full bg-[#00a7ee] text-white text-[14px] font-bold py-2 px-4 rounded-[16px] hover:bg-[var(--secondary)] cursor-pointer transition-colors"
                  onClick={() => {
                    router.push(`/login`);
                  }}>
                  Donate
