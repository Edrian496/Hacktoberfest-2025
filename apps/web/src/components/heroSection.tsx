...
const AirplanePlaceholder: React.FC<AirplaneProps> = ({ src, alt, className = '', style }) => (
  <img
    src={src}
    alt={alt}
  ...
  return (
    <section className="bg-[rgba(0,167,238,0.05)] h-screen min-h-[600px] relative flex items-center justify-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-8 text-center relative z-10 -mt-65"> 
        ...
        <div className="bg-[rgba(250,204,21,0.75)] rounded-[10px] px-8 sm:px-12 py-3 sm:py-4 inline-flex items-center justify-center cursor-pointer hover:bg-yellow-200 transition-colors" 
        onClick={handleDonateClick}>
          <span className="font-['Arimo:Regular',_sans-serif] font-normal text-[clamp(16px,1.875vw,18px)] text-blue-900 leading-[1.56]">
            Donate Now
          </span>
        </div>
      </div>
